...
import { UrpiMockApiReplyCallback } from '@urpi/lib/mock-api/mock-api.types';
import { Observable, of, take, throwError } from 'rxjs';

export class UrpiMockApiHandler {
    request!: HttpRequest<any>;
    urlParams!: { [key: string]: string };

    // Private
    private _reply: UrpiMockApiReplyCallback = undefined;
     ...
     * @param callback
     */
    reply(callback: UrpiMockApiReplyCallback): void {
        // Store the reply
