...
export class UrpiNavigationService {
    private _componentRegistry: Map<string, any> = new Map<string, any>();
    private _navigationStore: Map<string, UrpiNavigationItem[]> = new Map<
        string,
        any
    >();
     ...
     * @param navigation
     */
    storeNavigation(key: string, navigation: UrpiNavigationItem[]): void {
        // Add to the store
     ...
     * @param key
     */
    getNavigation(key: string): UrpiNavigationItem[] {
     ...
     */
    getFlatNavigation(
        navigation: UrpiNavigationItem[],
        flatNavigation: UrpiNavigationItem[] = []
    ): UrpiNavigationItem[] {
    ...
    getItemParent(
        id: string,
        navigation: UrpiNavigationItem[],
        parent: UrpiNavigationItem[] | UrpiNavigationItem
    ): UrpiNavigationItem[] | UrpiNavigationItem | null {
        for (const item of navigation) {
            if (item.id === id) {
                return parent;
            }
