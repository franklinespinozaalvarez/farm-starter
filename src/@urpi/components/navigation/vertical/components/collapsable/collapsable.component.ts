...
@Component({
    selector: 'urpi-vertical-navigation-collapsable-item',
    ...
    imports: [
        ...
        forwardRef(() => UrpiVerticalNavigationCollapsableItemComponent),
...
export class UrpiVerticalNavigationCollapsableItemComponent
    implements OnInit, OnDestroy
{
    ...
    @HostBinding('class') get classList(): any {
        /* eslint-disable @typescript-eslint/naming-convention */
        return {
            'urpi-vertical-navigation-item-collapsed': this.isCollapsed,
            'urpi-vertical-navigation-item-expanded': this.isExpanded,
        };
        /* eslint-enable @typescript-eslint/naming-convention */
    }
    ...
    ngOnInit(): void {
        ...
        this._urpiVerticalNavigationComponent.onCollapsableItemCollapsed
        ...
        if (this.autoCollapse) {
            this._urpiVerticalNavigationComponent.onCollapsableItemExpanded
                .pipe(takeUntil(this._unsubscribeAll))
    ...
    collapse(): void {
        ...
        this._urpiVerticalNavigationComponent.onCollapsableItemCollapsed.next(
            this.item
        );
    }
    ...
    expand(): void {
        ...
        // Execute the observable
        this._urpiVerticalNavigationComponent.onCollapsableItemExpanded.next(
            this.item
        );
    }
