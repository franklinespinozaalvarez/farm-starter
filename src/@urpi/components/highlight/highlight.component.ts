...
import { UrpiHighlightService } from '@urpi/components/highlight/highlight.service';

@Component({
    selector: 'textarea[urpi-highlight]',
    templateUrl: './highlight.component.html',
    styleUrls: ['./highlight.component.scss'],
    encapsulation: ViewEncapsulation.None,
    changeDetection: ChangeDetectionStrategy.OnPush,
    exportAs: 'urpiHighlight',
    standalone: true,
    imports: [NgClass],
})
export class UrpiHighlightComponent implements OnChanges, AfterViewInit {
    private _domSanitizer = inject(DomSanitizer);
    private _elementRef = inject(ElementRef);
    private _urpiHighlightService = inject(UrpiHighlightService);
    ...
    private _highlightAndInsert(): void {
        ...
        this.highlightedCode = this._domSanitizer.sanitize(
            ...
            this._urpiHighlightService.highlight(this.code, this.lang)
        );
