...
export class OrderComponent {
    ...
    public cols = [
        { field: 'farm', header: 'Granja', width: 'min-w-72'},
        { field: 'stage', header: 'Estapa', width: 'min-w-40'},
        { field: 'date', header: 'Fecha', width: 'min-w-40'},
        { field: 'quantity', header: 'Cantidad', width: 'min-w-40'}
    ];

    public displayedColumns = ['accion','farm','stage','date','quantity'];
    ...
    post(): void{
        this.action = 'new';
        // Create the provider
        let newFarm = {id: 0,farm: '',stage: '',date: '',quantity: ''};
