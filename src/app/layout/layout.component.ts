...
export class LayoutComponent implements OnInit, OnDestroy {
    ...
    constructor(
        ...
        private _urpiConfigService: UrpiConfigService,
        private _urpiMediaWatcherService: UrpiMediaWatcherService,
        private _urpiPlatformService: UrpiPlatformService
    ) {}
    ...
    ngOnInit(): void {
        ...
        combineLatest([
            this._urpiConfigService.config$,
            this._urpiMediaWatcherService.onMediaQueryChange$([
        ...
        this._renderer2.addClass(
            this._document.body,
            this._urpiPlatformService.osName
        );
    }
